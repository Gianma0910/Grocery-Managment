...
/**
 * Adapter that uses a List of Ingredient objects to show all the ingredients data of a recipe.
 * In this adapter its items can be modified or deleted.
 * This adapter must be set for AddRecipeActivity's RecyclerView.
 */
public class CustomAdapterIngredient extends RecyclerView.Adapter<IngredientViewHolder> {
     ...
     */
    public CustomAdapterIngredient(Context context) {
