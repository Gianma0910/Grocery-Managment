...
public class CustomAdapterIngredient2 extends RecyclerView.Adapter<IngredientViewHolder> {
     ...
     */
    public CustomAdapterIngredient2(Context context, Cursor cursor) {
    ...
    public void onBindViewHolder(@NonNull IngredientViewHolder holder, int position) {
        ...
        holder.buttonEditIngredient.setOnClickListener(view -> {
            if (onClickListener != null) {
                ...
                onClickListener.onEdit(holder.getAdapterPosition(), cursor.getInt(0), cursor.getString(1), cursor.getString(2));
            }
        });
        ...
        holder.buttonDeleteIngredient.setOnClickListener(view -> {
            if (onClickListener != null) {
                cursor.moveToPosition(holder.getAdapterPosition());
                onClickListener.onDelete(holder.getAdapterPosition(), cursor.getInt(0));
            }
        });
    }
