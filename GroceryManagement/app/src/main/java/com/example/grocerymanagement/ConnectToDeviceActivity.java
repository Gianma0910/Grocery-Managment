...
import classRecyclerView.CustomAdapter.CustomAdapterDiscoveryDevices;
...
public class ConnectToDeviceActivity extends AppCompatActivity {
    ...
    /**
     * String that represents the name for the extra Strng to put for an Intent.
     */
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        this.recyclerViewDevices.setItemAnimator(new CustomAnimatorSlideInOut());
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if (action.equals(BluetoothAdapter.ACTION_DISCOVERY_STARTED)) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.BLUETOOTH_CONNECT) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    adapterDiscoveryDevices.notifyItemInserted(devicesDiscovered.indexOf(deviceDiscovered));

                    adapterDiscoveryDevices.setNameDiscoveredDevices(nameDevicesDiscovered);
                    adapterDiscoveryDevices.notifyItemInserted(nameDevicesDiscovered.indexOf(deviceDiscovered.getName()));
                }
            }
        }
    };
    ...
    private class ConnectThread extends Thread {
        ...
        private void handleConnectedSocket(BluetoothSocket socket) {
            try {
                ...
                runOnUiThread(() -> {
                    showCustomSnackbar("Error on reading the sharec recipes data", R.drawable.ic_warning_error);
                });
            }
        }
